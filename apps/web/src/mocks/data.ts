...
const mockFlowSeed = [
  {
    ...
    srcIp: '192.168.1.100',
    srcPort: 53412,
    dstIp: '142.250.184.46',
    dstPort: 443,
    dstDomain: 'www.google.com',
    processName: 'chromium',
    matchedRuleIndex: 3,
    matchedRuleText: 'domain(geosite:google) -> proxy',
    outboundName: 'proxy',
    groupName: 'proxy',
    nodeId: 'node-2',
    nodeName: 'US Node 01',
  ...
  },
  {
    ...
    processName: 'firefox',
    matchedRuleIndex: 1,
    matchedRuleText: 'domain(geosite:cn) -> direct',
    outboundName: 'direct',
    groupName: null,
    nodeId: null,
    nodeName: null,
  ...
  {
    id: 'flow-3',
    startedAt: new Date(Date.now() - 3_500).toISOString(),
    endedAt: null,
    l4proto: 'udp',
    srcIp: '192.168.1.100',
    srcPort: 60123,
    dstIp: '1.1.1.1',
    dstPort: 53,
    dstDomain: 'cloudflare-dns',
    processName: 'systemd-resolved',
    matchedRuleIndex: 0,
    matchedRuleText: 'dport(53) -> direct',
    outboundName: 'direct',
    groupName: null,
    nodeId: null,
    nodeName: null,
  ...
  },
  {
    ...
    dstIp: '13.107.42.14',
    dstPort: 443,
    dstDomain: 'outlook.office.com',
    processName: 'thunderbird',
    matchedRuleIndex: 5,
    matchedRuleText: 'ip(geoip:!cn) -> proxy',
    outboundName: 'proxy',
    groupName: 'proxy',
    nodeId: 'node-1',
    nodeName: 'HK Node 01',
    uploadBytes: '120000',
    downloadBytes: '720000',
    status: 'established',
  },
  {
    id: 'flow-5',
...
export const mockFlowsStats = {
  flowsStats: {
    windowSec: 60,
    totalFlows: mockFlowSeed.length,
    ...
    outboundHits: [
      { outboundName: 'proxy', groupName: 'proxy', hits: 3, uploadBytes: '144356', downloadBytes: '1707765' },
      { outboundName: 'direct', groupName: null, hits: 2, uploadBytes: '4158', downloadBytes: '39424' },
    ],
  },
}
